...
/** http://jvectormap.com
 **************************************************************** **/
function _jvectormap() {

    if (jQuery("body").hasClass('jmap')) {
        loadScript(plugin_path + 'jvectormap/jquery-jvectormap-2.0.3.min.js', function () {
            loadScript(plugin_path + 'jvectormap/jquery-jvectormap-cn-mill.js', function () {
                loadScript(plugin_path + 'jvectormap/jquery-jvectormap-world-mill.js', function () {
                });
            });
        });
    }
...
/** 002. GreenSock About Us
 **************************************************************** **/
function _bootstrapToogle() {

    if (jQuery("body").hasClass('checkbox-inline')) {
        loadScript(plugin_path + '/bootstrap-toggle/js/bootstrap-toggle.js', function () {
...
/** 001. GreenSock About Us
 **************************************************************** **/
function _aboutUs() {
    if (jQuery("body").hasClass('aboutus_x')) {
        var controller = new ScrollMagic.Controller();

        blockTween = new TweenMax.to('#fly-2016', 1.5, {css: {transform: 'translate(0)'}});
        scene = new ScrollMagic.Scene({
            offset: jQuery('#fly-2016').offset().top - 0,
            duration: 400
        }).setTween(blockTween).addTo(controller);

        blockTween = new TweenMax.to('#fly-2015', 1.5, {css: {transform: 'translate(0)'}});
        scene = new ScrollMagic.Scene({
            offset: jQuery('#fly-2015').offset().top - 100,
            duration: 400
        }).setTween(blockTween).addTo(controller);

        blockTween = new TweenMax.to('#fly-2014', 1.5, {css: {transform: 'translate(0)'}});
        scene = new ScrollMagic.Scene({
            offset: jQuery('#fly-2014').offset().top - 100,
            duration: 400
        }).setTween(blockTween).addTo(controller);

        blockTween = new TweenMax.to('#fly-2013', 1.5, {css: {transform: 'translate(0)'}});
        scene = new ScrollMagic.Scene({
            offset: jQuery('#fly-2013').offset().top - 100,
            duration: 400
        }).setTween(blockTween).addTo(controller);

        blockTween = new TweenMax.to('#fly-2012', 1.5, {css: {transform: 'translate(0)'}});
        scene = new ScrollMagic.Scene({
            offset: jQuery('#fly-2012').offset().top - 100,
            duration: 400
        }).setTween(blockTween).addTo(controller);

        blockTween = new TweenMax.to('#fly-2011', 1.5, {css: {transform: 'translate(0)'}});
        scene = new ScrollMagic.Scene({
            offset: jQuery('#fly-2011').offset().top - 100,
            duration: 400
        }).setTween(blockTween).addTo(controller);
...
function _topNav() {
    ...
    // Recovers hidden content at news level
    jQuery(".blog-item-small-content .btn-coverage").bind("click", function (e) {
        e.preventDefault();
        div_height = jQuery(this).closest('.blog-post-item').find('.content').prop('scrollHeight');
        //jQuery(this).prev('.content').addClass('blog-full');
        jQuery(this).closest('.blog-post-item').find('.content').animate({height: div_height}, 0);
        jQuery(this).closest('.blog-post-item').find('.btn-default').fadeOut();
    });
...
function _popover() {
    ...
    jQuery("a[data-toggle=popover]").on("mouseover", function (e) {
        ...
        if (_slider.hasClass('parallax-slider')) {
            ...
            jQuery(window).scroll(function () {
                ...
                if (_currentTop < 768) {
                    ...
                    jQuery('#slider>div').css('top', (_currentTop * .5));
 ...
 **************************************************************** **/
function _lazyload() {
    var _container = jQuery('.b-lazy');

    if (_container.length > 0) {
        loadScript(plugin_path + 'blazy/blazy.min.js', function () {
...
function _form() {
    ...
    /** Form Validate
     ************************ **/
    if (jQuery('form.validate-nosend').length > 0) {
        ...
        loadScript(plugin_path + 'form.validate/jquery.form.min.js', function () {
            loadScript(plugin_path + 'form.validate/jquery.validation.min.js', function () {
                ...
                if (jQuery().validate) {
                    ...
                    jQuery('form.validate-nosend').each(function () {
